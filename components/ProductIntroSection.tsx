...
export default function ProductIntroSection() {
  return (
    <section className="relative w-full bg-white lg:py-0">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[80vh] ">
          ...
          <div className="space-y-6">
            ...
            {/* Main Heading */}
            <h2 className="text-black text-4xl md:text-5xl lg:text-6xl font-weight-500 leading-tight">
              NeuroDrishti<br />Smartglasses
            </h2>

            {/* Subheading */}
            <p className="text-2xl md:text-3xl font-weight-500 text-gray-800">
              Your Vision Companion.
            </p>

            {/* Description */}
            <p className="text-gray-600 text-md md:text-2xl font-weight-500 leading-relaxed max-w-lg">
